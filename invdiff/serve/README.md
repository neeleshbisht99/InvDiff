...
4. Run `python -m invdiff.serve.utils_vlm` to test the BLIP.

Note: We need to create a separate virtual environment for this, else there will be dependency conflicts.